...
public class EmabriEntity extends TamableAnimal implements IAnimatable, PlayerRideableJumping {
    private AnimationFactory factory = new AnimationFactory(this);
    public EmabriEntity(EntityType<? extends TamableAnimal> p_27557_, Level p_27558_) {
    ...
    public boolean isFood(ItemStack pStack) {
        return pStack.getItem().equals(Items.MUSHROOM_STEW);
    }
    ...
    public InteractionResult mobInteract(Player p_30412_, InteractionHand p_30413_) {
        ...
        if (this.level.isClientSide) {
            ...
            } else if ((itemstack.is(Items.TROPICAL_FISH) || itemstack.is(Items.COD) || itemstack.is(Items.SALMON))) {
                if (!p_30412_.getAbilities().instabuild) {
                    itemstack.shrink(1);
                }

                if (this.random.nextInt(5) == 0 && !net.minecraftforge.event.ForgeEventFactory.onAnimalTame(this, p_30412_)) {
                    this.tame(p_30412_);
                    this.navigation.stop();
                    this.setTarget((LivingEntity)null);
    ...
    protected SoundEvent getAmbientSound() {
        return ModSounds.EMABRI_IDLE.get();
    }

    @Nullable
    @Override
    protected SoundEvent getHurtSound(DamageSource pDamageSource) {
        return ModSounds.EMABRI_HIT.get();
    }
    ...
    public void travel(Vec3 vec3d) {
        if (this.isAlive()) {
            ...
            else if(this.isInWater() && !(this.getTarget() instanceof LivingEntity)) {
                super.travel(vec3d);
