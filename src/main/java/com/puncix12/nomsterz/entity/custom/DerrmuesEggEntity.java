...
public class DerrmuesEggEntity extends Animal implements IAnimatable {
    private AnimationFactory factory = new AnimationFactory(this);
    public DerrmuesEggEntity(EntityType<? extends Animal> p_27557_, Level p_27558_) {
    ...
    private <E extends IAnimatable> PlayState predicate(AnimationEvent<E> event) {
        event.getController().setAnimation(new AnimationBuilder().addAnimation("animation.derrmues_egg.idle", true));
    ...
    public void tick() {
        ...
        if ( blockstate.is(Blocks.GRASS_BLOCK) && shouldHatch == 10000 && (blockstate1.is(Blocks.OXEYE_DAISY) || blockstate1.is(Blocks.DANDELION)
        && (blockstate2.is(Blocks.OXEYE_DAISY) || blockstate2.is(Blocks.DANDELION)) && (blockstate3.is(Blocks.OXEYE_DAISY) || blockstate3.is(Blocks.DANDELION))
        && (blockstate4.is(Blocks.OXEYE_DAISY) || blockstate4.is(Blocks.DANDELION)))){
        ...
        if(blockstate.is(Blocks.GRASS_BLOCK)&& (blockstate1.is(Blocks.OXEYE_DAISY) || blockstate1.is(Blocks.DANDELION)
                && (blockstate2.is(Blocks.OXEYE_DAISY) || blockstate2.is(Blocks.DANDELION)) && (blockstate3.is(Blocks.OXEYE_DAISY) || blockstate3.is(Blocks.DANDELION))
                && (blockstate4.is(Blocks.OXEYE_DAISY) || blockstate4.is(Blocks.DANDELION)))) {
            shouldHatch++;
        }
