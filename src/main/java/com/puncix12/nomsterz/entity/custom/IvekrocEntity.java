...
public class IvekrocEntity extends TamableAnimal implements IAnimatable, PlayerRideableJumping {
    private AnimationFactory factory = new AnimationFactory(this);
    public IvekrocEntity(EntityType<? extends TamableAnimal> p_27557_, Level p_27558_) {
    ...
    public AgeableMob getBreedOffspring(ServerLevel serverLevel, AgeableMob mob) {
        return ModEntityTypes.IVEKROC.get().create(serverLevel);
    }

    @Override
    public boolean isFood(ItemStack pStack) {
        return pStack.getItem().equals(Items.COD);
    }
    ...
    public InteractionResult mobInteract(Player p_30412_, InteractionHand p_30413_) {
        ...
        if (this.level.isClientSide) {
            ...
            } else if (itemstack.is(Items.AXOLOTL_BUCKET)) {
                if (!p_30412_.getAbilities().instabuild) {
                    itemstack.shrink(1);
                }
    ...
    protected SoundEvent getAmbientSound() {
        return ModSounds.IVEKROC_IDLE.get();
    }

    @Nullable
    @Override
    protected SoundEvent getHurtSound(DamageSource pDamageSource) {
        return ModSounds.IVEKROC_HIT.get();
    }

    @Nullable
    @Override
    protected SoundEvent getDeathSound() {
        return ModSounds.IVEKROC_DEATH.get();
    }
