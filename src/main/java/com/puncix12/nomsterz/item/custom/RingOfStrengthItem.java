...
public class RingOfStrengthItem extends Item {

    public RingOfStrengthItem(Properties p_41383_) {
        super(p_41383_);
    }
    @Override
    public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced) {
        if(Screen.hasShiftDown()) {
            pTooltipComponents.add(Component.literal("This ring gives strength I").withStyle(ChatFormatting.AQUA));
        } else {
