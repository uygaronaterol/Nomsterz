...
public class DerrmuesEggItem extends Item {
    public DerrmuesEggItem(Properties pProperties) {
        super(pProperties);
    }
    ...
    public @NotNull InteractionResult useOn(UseOnContext pContext) {
        ...
        if ( blockstate.is(Blocks.GRASS_BLOCK)) {
            DerrmuesEggEntity derrmues = ModEntityTypes.DERRMUES_EGG.get().create(level);
            derrmues.moveTo(pPos.getX(), pPos.getY() + 1, pPos.getZ(), entity.getYRot(), entity.getXRot());
